...
<div class="main-container container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="<?php echo e(route('directeurcentrale.stock.store')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="card-header">
                    <div class="card-title"><?php echo e(__('Ajouter le stock d\'aides techniques')); ?></div>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $delegations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delegation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($delegation->id); ?> " <?php echo e(old('delegation_id') == $delegation->id ? 'Selected' : ''); ?>><?php echo e($delegation->label); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-4">
                    <label class="col-md-3 form-label" for="disabilitie_id"><?php echo e(__('Aide technique')); ?></label>
                    <div class="col-md-9">
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $equipements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($equipement->id); ?> " <?php echo e(old('equipement_id') == $equipement->id ? 'Selected' : ''); ?>><?php echo e($equipement->label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\html\resources\views/directeurcentrale/stocks/create.blade.php ENDPATH**/ ?>