...
<div class="main-container container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="<?php echo e(route('servicetechnique.user.store')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="card-header">
                    <div class="card-title"><?php echo e(__('AjouterUser')); ?></div>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
...
unset($__errorArgs, $__bag); ?>" placeholder="Gmail@gmail.com ">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-4">
                        <label class="col-md-3 form-label"> <?php echo e(__('Tél')); ?> :</label>
                        <div class="col-md-9">
                            <input type="number" name="phone" id="phone" class="form-control  <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="0600000000 ">
...
unset($__errorArgs, $__bag); ?>" id="role" value="<?php echo e($role->id); ?> ">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\html\resources\views/servicetechnique/users/create.blade.php ENDPATH**/ ?>