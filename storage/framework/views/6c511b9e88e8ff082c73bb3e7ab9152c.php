        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header justify-content-between d-flex align-items-center">
                    <h4 class="card-title"><?php echo e(__('Profil')); ?></h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/agentcoaph/profile.blade.php ENDPATH**/ ?>