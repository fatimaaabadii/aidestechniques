        ...
        <div class="w-1/2 px-5 py-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8">
            ...
            <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    <div>
                        <div class="flex items-center justify-center">
                            <img class="p-8 rounded-t-lg" src="<?php echo e(asset('assets/beneficiers/icon1.png')); ?>" alt="product image" />
                        </div>
                    </div>
                    <div class="px-14 pb-5">
                        <div class="flex items-center justify-center">
                            <a href="<?php echo e(route('demmande.get')); ?>"
                ...
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    <div>
                        <div class="flex items-center justify-center">
                            <img class="p-8 rounded-t-lg" src="<?php echo e(asset('assets/beneficiers/icon2.png')); ?>" alt="product image" />
                        </div>
                    </div>
                    <div class="px-14 pb-5">
                        <div class="flex items-center justify-center">
                            <a href="<?php echo e(route('demand.suivi')); ?>"
                                class="text-white hover:text-fuchsia-900 bg-fuchsia-900 hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-14 py-2.5 text-center">
                                Suivre ma demande</a>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\hp\Downloads\html\resources\views/home.blade.php ENDPATH**/ ?>