                                    ...
                                    <div class="card-body">
                                        <div class="py-2">
                                            ...
                                            <div class="d-flex mt-4 align-items-center">
                                                <div id="mini-1" data-colors='["--bs-success"]' class="apex-charts">
                                                </div>
                                                <div class="ms-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-1 px-2">
                            ...
                            <div class="order-wid-list d-flex justify-content-between">
                                <p class="mb-0"><i
                                        class="mdi mdi-square-rounded font-size-10 text-danger me-2"></i>Order Cancel
                                </p>
                                <div>
                                        ...
                                        <ol class="activity-checkout mb-0 mt-2 ps-3">
                                                ...
                                                <div class="feed-item-list">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 overflow-hidden me-4">
                                                            <h5 class="font-size-15 mb-1 text-truncate">Have 5 pending
                                                                order.</h5>
                                            ...
                                            <li class="checkout-item crypto-activity">
                                                ...
                                                <div class="feed-item-list">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 overflow-hidden me-4">
                                                            <h5 class="font-size-15 mb-1 text-truncate">Manager Posted
                                                            </h5>
                                            ...
                                            <li class="checkout-item crypto-activity">
                                                ...
                                                <div class="feed-item-list">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 overflow-hidden me-4">
                                                            <h5 class="font-size-15 mb-1 text-truncate">Have 1 pending
                                                                order.</h5>
                                            ...
                                            <li class="checkout-item crypto-activity">
                                                ...
                                                <div class="feed-item-list">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 overflow-hidden me-4">
                                                            <h5 class="font-size-15 mb-1 text-truncate">Order Received
                                                            </h5>
                                        ...
                                        <div class="card dash-product-box shadow-none border mb-0">
                                            <div class="card-body">
                                                ...
                                                <h5 class="font-size-17 mt-1">
                                                    <a href="" class="text-dark lh-base">Stylish Cricket & Walking Light
                                                        Weight Shoes</a>
                                                </h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card dash-product-box shadow-none border mb-0">
                                            <div class="card-body">
                                                ...
                                                <h5 class="font-size-17 mt-1">
                                                    <a href="" class="text-dark lh-base">Combo Pack of 2 Sports Shoes
                                                        Running Shoes</a>
                                                </h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card dash-product-box shadow-none border mb-0">
                                            <div class="card-body">
                                                ...
                                                <h5 class="font-size-17 mt-1">
                                                    <a href="" class="text-dark lh-base">Trendy Men Sports Running
                                                        Running Shoes</a>
                                                </h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card dash-product-box shadow-none border mb-0">
                                            <div class="card-body">
                                                ...
                                                <h5 class="font-size-17 mt-1">
                                                    <a href="" class="text-dark lh-base">Sneakers For Women Sports
