            ...
            <div class="w-1/2 px-5 py-4  bg-white border border-gray-200 rounded-lg shadow sm:p-8">
                ...
                <section class="bg-white ">
                    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                        <form action="{{ route('demand.store') }}" class="flex flex-col" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                {{-- <div>
                                    ...
                                    <select
                                        ...
                                        name="region"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                        <option selected="0">Choisir une region</option>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        @foreach ($disabilities as $disabilitie)
                                            <option value="{{ $disabilitie->id }}">{{ $disabilitie->label }}</option>
                                        @endforeach
                                    </select>
                                    @error('handicap')
                                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
