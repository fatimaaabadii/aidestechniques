<header id="page-topbar">
           ...
           <div class="dropdown d-inline-block language-switch">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="{{ route('supperadmin.profile') }}"><i class="mdi mdi-account-circle text-muted font-size-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                    ...
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button class="dropdown-item" type="submit"><i class="mdi mdi-logout text-muted font-size-16 align-middle me-1"></i> <span class="align-middle">Logout</span></button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="verti-dash-content" style="background: rgb(59 86 49)">
