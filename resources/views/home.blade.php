...
<body>
    ...
    <nav class="bg-white  w-full  border-b border-gray-200">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                <img src="{{ asset('assets/beneficiers/logo1.png') }}" class="h-12 mr-3" alt="Flowbite Logo" />
            </a>
            <div class="flex md:order-2">
                <a href="#" class="flex items-center">
                    <img src="{{ asset('assets/beneficiers/logo2.png') }}" class="h-16 mr-3" alt="Flowbite Logo" />
                </a>
    ...
    <div class=" w-full h-20 bg-[url('{{ asset('assets/beneficiers/morocooc2.png') }}')] opacity-20	"></div>
    <!--This is canter-->
    <div class="w-full flex justify-center  sm:py-8">
        <div class="w-1/2 px-5 py-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8">
            <h5 class="mb-10 text-3xl font-bold text-fuchsia-900">Créer et suivre vos demandes d'aides techniques</h5>

            <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    <div>
                        <div class="flex items-center justify-center">
                            <img class="p-8 rounded-t-lg" src="{{ asset('assets/beneficiers/icon1.png') }}" alt="product image" />
                        </div>
                    </div>
                    <div class="px-14 pb-5">
                        <div class="flex items-center justify-center">
                            <a href="{{ route('demmande.get') }}"
                                class="text-white hover:text-fuchsia-900 bg-fuchsia-900 hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-14 py-2.5 text-center">
                ...
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                    <div>
                        <div class="flex items-center justify-center">
                            <img class="p-8 rounded-t-lg" src="{{ asset('assets/beneficiers/icon2.png') }}" alt="product image" />
                        </div>
                    </div>
                    <div class="px-14 pb-5">
                        <div class="flex items-center justify-center">
                            <a href="{{ route('demand.suivi') }}"
                                class="text-white hover:text-fuchsia-900 bg-fuchsia-900 hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-14 py-2.5 text-center">
                                Suivre ma demande</a>
                        </div>
                    </div>
    ...
    <footer class="bg-gray-500 bg-[url('{{ asset('assets/beneficiers/morocooc.png') }}')]">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="#" class="flex items-center bg-white rounded-lg p-5">
                        <img src="{{ asset('assets/beneficiers/logo1.png') }}" class="h-8 mr-3" alt="FlowBite Logo" />
                    </a>
                </div>
