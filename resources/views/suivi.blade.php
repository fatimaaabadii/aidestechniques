...
<body>
    ...
    <div class="w-full flex justify-center  sm:py-8">
        <div class="w-1/2 px-5 py-4  bg-white border border-gray-200 rounded-lg shadow sm:p-8">
            <h5 class=" text-4xl text-center font-bold text-fuchsia-900"> Suivre ma demande</h5>


            <section class="bg-white ">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <form action="{{ route('demand.track') }}" class="flex flex-col" method="POST">
                        @csrf
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">

                            <div class="w-full">
                                <label for="trackNumber" class="block mb-2 text-sm font-medium text-gray-900 ">
                                    Code de
                                    Suivi
                                </label>
                                <input
                        ...
                        <button type="submit"
                            class="inline-flex items-center flex justify-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-fuchsia-900 rounded-lg focus:ring-4 focus:ring-primary-200  hover:bg-primary-800">
                            Envoyer
                        </button>
                    </form>
                </div>
